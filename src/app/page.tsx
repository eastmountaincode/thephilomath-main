      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <section className="mb-12">
          ...
          <a
            ...
            className="inline-block rounded bg-[var(--berkeley-blue)] px-6 py-3 font-semibold text-white transition-colors hover:bg-[var(--california-gold)] hover:text-[var(--berkeley-blue)] hover:no-underline"
          >
            Read the book →
          </a>
        </section>
